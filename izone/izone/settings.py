...
EMAIL_HOST_USER = 'selonsy@163.com'
EMAIL_HOST_PASSWORD = 'your-password'  # 这个不是邮箱密码，而是授权码
EMAIL_PORT = 465  # 由于阿里云的25端口打不开，所以必须使用SSL然后改用465端口
# 是否使用了SSL 或者TLS，为了用465端口，要使用这个
EMAIL_USE_SSL = True
# 默认发件人，不设置的话django默认使用的webmaster@localhost，所以要设置成自己可用的邮箱
DEFAULT_FROM_EMAIL = 'selonsy <selonsy@163.com>'

# 网站默认设置和上下文信息
SITE_END_TITLE = 'Vmatrix'
SITE_DESCRIPTION = '一个使用django和bootstrap搭建的个人博客'
SITE_KEYWORDS = 'selonsy,vmatrix,django,bootstrap'
